...
The current public catalogs list Asura Scans v17, WeebCentral v21, nhentai v25, WEBTOON v23, IMHentai v31 and HentaiFox v35. On 2026-09-25, all four public index feeds (canonical and experimental for both PanelNest and the legacy mirror) returned HTTP 200; every listed package downloaded successfully and matched the byte count and SHA-256 in its source `verification.json`. The source build and Pages deployment passed in Actions run 36130360409, and the legacy mirror passed in run 36130372942.
