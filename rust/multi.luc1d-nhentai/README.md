...
## Website-backed capabilities (source version 7)
...
The editable blocklist now starts empty; the former `example` placeholder was an active exclusion in all browse queries.
