...
Quick-select menus show the 25 most popular tags and up to 50 popular entries for each other category. The version 15 text filters can open additional categories when their ASCII site name or slug is known. Names with non-ASCII characters are not converted automatically; enter their official ASCII slug instead.
